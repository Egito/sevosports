...
function sevo_org_shortcode($atts) {
    ...
    $owner_id = get_post_meta($atts['id'], 'sevo_org_proprietario', true);
    ...
    // Carrega o template
    include plugin_dir_path(__FILE__) . '../view/sevo-org-view.php';

    // Retorna o conteúdo do buffer
    return ob_get_clean();
}
add_shortcode('sevo-org', 'sevo_org_shortcode');