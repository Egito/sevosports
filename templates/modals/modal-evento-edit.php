...
$featured_image_id = $is_editing ? get_post_thumbnail_id($post_id) : 0;
$featured_image_url = $featured_image_id ? wp_get_attachment_image_url($featured_image_id, 'medium') : '';

// Busca os "Tipos de Evento" para o dropdown
...
<div class="sevo-modal-container">
    <div class="sevo-modal-header">
        ...
        <div class="sevo-form-grid">
            ...
            <div class="sevo-form-two-columns">
                <!-- Coluna esquerda -->
                <div class="sevo-form-column-left">
                    <!-- Tipo de Evento -->
                ...
                <div class="sevo-form-column-right">
                    <div class="sevo-form-group">
                        <label for="featured_image">Imagem do Evento</label>
                        <div class="sevo-image-upload-container">
                            <div class="sevo-image-preview" id="sevo-image-preview">
                                <?php if ($featured_image_url) : ?>
                                    <img src="<?php echo esc_url($featured_image_url); ?>" alt="Imagem do evento" id="sevo-preview-img">
                            ...
                            <button type="button" class="sevo-button-secondary sevo-upload-btn" id="sevo-upload-btn">
                                <?php echo $featured_image_url ? 'Alterar Imagem' : 'Adicionar Imagem'; ?>
                            </button>
                        </div>
                        <small class="sevo-form-help">Imagem será redimensionada para 300x300 pixels</small>
                    </div>
                </div>
            </div>
