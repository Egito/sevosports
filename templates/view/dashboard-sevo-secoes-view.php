...
/**
 * Enqueue styles and scripts for the dashboard
 *
 * - dashboard-sevo-secoes.css: Estilos específicos do dashboard de seções
 * - dashboard-sevo-secoes.js: Scripts principais do dashboard
 * - Localiza script com dados AJAX para comunicação com o backend
 */
...
require_once plugin_dir_path(__FILE__) . 'templates/view/summary-cards.php';
