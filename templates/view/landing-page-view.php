...
<div class="sevo-landing-page-container">
    ...
    <!-- 6. Seção vazia caso não haja eventos -->
    <?php if ($section_counts['inscricoes_abertas'] == 0 && $section_counts['em_andamento'] == 0 && $section_counts['encerrados'] == 0): ?>
